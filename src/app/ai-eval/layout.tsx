      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-neutral-950 px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/"
              className="p-2 rounded-xl bg-neutral-900 border border-white/[0.06] hover:border-orange-500/40 text-neutral-400 hover:text-white transition-all group"
          ...
          <div className="flex items-center gap-4">
            {evaluatorName ? (
              <div className="flex items-center gap-3 bg-neutral-900 border border-white/[0.06] rounded-2xl px-3.5 py-1.5">
                <div className="w-7 h-7 rounded-lg bg-orange-500/20 text-orange-400 font-mono text-xs font-bold flex items-center justify-center border border-orange-500/30">
